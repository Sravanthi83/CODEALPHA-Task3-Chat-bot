...
def chatbot_response(user_input):
    if user_input.lower() == "hello" or user_input.lower() == "hi" or user_input.lower() == "hey":
    ...
    elif user_input.lower() == "what is your name" or user_input.lower() == "your name" or user_input.lower() == "Who are you":
        ...
        return "I'm just a simple chatbot. I don't understand that,please provide valid data."
